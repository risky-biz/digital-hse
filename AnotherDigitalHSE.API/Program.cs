...
using AnotherDigitalHSE.API.Services;
...
builder.Services.AddDbContext<AnotherDigitalHSEDBContext>(options =>
...
static void MigrateDatabase(IApplicationBuilder app)
{
    ...
    var context = serviceScope.ServiceProvider.GetService<AnotherDigitalHSEDBContext>();
