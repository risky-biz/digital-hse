...
using DigitalHSE.Application.Features.SampleModel.Commands.CreateSampleModel;
using DigitalHSE.Application.Features.SampleModel.Commands.DeleteSampleModel;
using DigitalHSE.Application.Features.SampleModel.Commands.UpdateSampleModel;
using DigitalHSE.Application.Features.SampleModel.Queries.GetAllSampleModels;
using DigitalHSE.Application.Features.SampleModel.Queries.GetGenderEnum;
using DigitalHSE.Application.Features.SampleModel.Queries.GetSampleModelById;
using DigitalHSE.Application.Features.SampleModel.Queries.GetSampleModelsByFilter;
using DigitalHSE.Application.Features.SampleModel.Queries.GetSampleModelTotalCount;
using DigitalHSE.Application.ViewModels;
using Swashbuckle.AspNetCore.Annotations;

namespace DigitalHSE.API.Controllers;
